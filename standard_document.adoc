:Title: Volume 12: OGC CDB Navaids Attribution and Navaids Attribution Enumeration Values (Best Practice)
:titletext: Volume 12: OGC CDB Navaids Attribution and Navaids Attribution Enumeration Values (Best Practice)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/CDB-navaids/1.3
|Internal reference number of this OGC(R) document:        16-003r5
|Version: 1.3
